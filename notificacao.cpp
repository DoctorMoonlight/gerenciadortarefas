...
Notificacao::Notificacao(const string& mensagem, const string& data, const string&
horario)
...
void Notificacao::notificar() const {
 cout << "Notificação: " << mensagem << " em " << data << " às " << horario << endl; 
#ifdef _WIN32
...
std::tm Notificacao::stringParaTm(const string& data, const string& horario) const {
